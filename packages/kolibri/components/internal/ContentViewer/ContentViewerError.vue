  ...
  export default {
    ...
    $trs: {
      rendererNotAvailable: {
        message: 'PHIEDU is unable to render this resource',
        context:
          'This message is displayed when PHIEDU is unable to properly load or display the requested resource (could be either server loading error, or something wrong with the resource format itself).',
      },
    },
  };

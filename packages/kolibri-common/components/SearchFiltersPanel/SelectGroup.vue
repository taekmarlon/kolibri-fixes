...
<style lang="scss" scoped>
  ...
  ::v-deep .ui-select-label-text.is-inline {
    position: absolute;
    bottom: 45px;
    left: 10px;
    font-size: 12px;
  ...
  ::v-deep .ui-select-label-text.is-floating {
    position: absolute;
    bottom: 15px;
    left: 10px;
    font-size: 12px;
  ...
  ::v-deep .ui-select-display {
    height: 3rem;
    border-bottom: inherit;
  }

  ::v-deep .ui-select-display-value {
    position: relative;
    top: 12px;
    flex-grow: 1;
    height: 32px;

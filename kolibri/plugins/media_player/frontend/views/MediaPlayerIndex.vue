...
<style lang="scss" scoped>
  ...
  ::v-deep .vjs-has-started.vjs-playing.vjs-user-inactive .vjs-control-bar {
    visibility: hidden;
  ...
  ::v-deep .vjs-captions-button.active .vjs-icon-placeholder,
  ::v-deep .vjs-languages-button.active .vjs-icon-placeholder {

...
<script>
  ...
  export default {
    ...
    $trs: {
      ...
      noImportableDrives: {
        message: 'No USB or network drives with PHIEDU resources are connected to the server.',
        context:
          "Error message that refers to importing resources. If the drive being used doesn't have PHIEDU resources on it, then this message will display.",
      },

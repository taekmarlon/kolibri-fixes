...
<script>
  ...
  export default {
    ...
    $trs: {
      kolibriUsersP1: {
        message:
          'You should use PHIEDU in compliance with all applicable laws. This may mean obtaining permission from your parent, guardian, or teacher.',
        context:
          'This text forms part of the \'Usage and privacy\' information panel in PHIEDU. You can access the full text via the "Usage and privacy" link in the left navigation bar.',
      },
      kolibriUsersP2: {
        message:
      ...
      kolibriUsersP3: {
        message:
          "Please contact your local PHIEDU administrator to understand what personal information of yours might be stored, who it's visible to, how to update or delete it, or if you believe your account has been compromised.",
        context:
          'This text forms part of the \'Usage and privacy\' information panel in PHIEDU. You can access the full text via the "Usage and privacy" link in the left navigation bar.',
      },
      kolibriUsersP4: {
      ...
      kolibriUsersL3: {
        message:
          'Remove, circumvent, disable, damage or otherwise interfere with security-related features of PHIEDU',
        context:
          'This text forms part of the \'Usage and privacy\' information panel in PHIEDU. You can access the full text via the "Usage and privacy" link in the left navigation bar.',
      },
      kolibriUsersL4: {
        message:
          "Intentionally interfere with or damage the operation of PHIEDU or any user's enjoyment of it, by any means",

        context: 'Part of the "Usage and privacy" recommendations.',
      },
      kolibriUsersP5: {
        message:
          'When you use PHIEDU as a logged-in user, information such as your name, username, age, birth year, identification number, the resources that you view, and your performance on assessments may be made available to administrators and coaches in your facility. Your information may also be used by the developers of PHIEDU and shared with content creators to help improve the software and resources for different learner types and needs.',
        context:
          'This text forms part of the \'Usage and privacy\' information panel in PHIEDU. You can access the full text via the "Usage and privacy" link in the left navigation bar.',
      },
      kolibriUsersP6: {
        message:
          'When you use PHIEDU as a guest, aggregate information about the resources you and other guest users view may be available to administrators and certain coaches.',
        context:
          'This text forms part of the \'Usage and privacy\' information panel in PHIEDU. You can access the full text via the "Usage and privacy" link in the left navigation bar.',
      },
      kolibriOwnersTitle: {
        ...
        context:
          'Title of a section in the \'Usage and privacy\' information panel. The section contains information about for administrators who are running and maintaining PHIEDU.\n\nYou can access the full text via the "Usage and privacy" link in the left navigation bar.',
      },
      kolibriOwnersP1: {
        message:
          'You should run PHIEDU as a service in compliance with all applicable laws. If you are the owner of the device that PHIEDU is installed on, please be aware that you are ultimately responsible for the safety and protection of the user data that gets stored in PHIEDU.',
        context:
          'This text forms part of the \'Usage and privacy\' information panel in PHIEDU. You can access the full text via the "Usage and privacy" link in the left navigation bar.',
      },
      kolibriOwnersP2: {
      ...
      kolibriAboutTitle: {
        message: 'About PHIEDU',
        context:
          "Title of a section in the 'Usage and privacy' information panel. The section contains information about PHIEDU.\n\nYou can access the full text via the 'Usage and privacy' link in the left navigation bar.\n",
      },
      kolibriAboutP1: {
        message:
          "The PHIEDU software is built by Foundation for Learning Equality, Inc. More information, including PHIEDU's Terms of Service and Privacy Policy, can be found at:",
        context:
          'This text forms part of the \'Usage and privacy\' information panel in PHIEDU. You can access the full text via the "Usage and privacy" link in the left navigation bar.',
      },
      kolibriAboutP2: {
        message:
          'PHIEDU is a software application that can be installed on a wide variety of devices without needing a connection to the internet.',
        context:
          'This text forms part of the \'Usage and privacy\' information panel in PHIEDU. You can access the full text via the "Usage and privacy" link in the left navigation bar.',
      },
      kolibriAboutP3: {
        message:
          'Unlike many online web services that are similarly accessed through a web browser, there are thousands of independent PHIEDU installations around the world – including this one. Each PHIEDU installation is managed and controlled by the owner of the device that it is installed on.',
        context:
          'This text forms part of the \'Usage and privacy\' information panel in PHIEDU. You can access the full text via the "Usage and privacy" link in the left navigation bar.',
      },
      kolibriAboutP4: {
      ...
      kolibriAboutP5: {
        message:
          'In order to improve the quality of PHIEDU and the resources on it, Learning Equality collects anonymized usage information when PHIEDU has access to the internet. This includes IP addresses associated with the server, and device details such as the operating system and time zone. We also collect aggregate statistics including: number of users and facilities, birth year and gender distribution, and resource popularity. We make every effort to avoid collecting personally identifying information about PHIEDU users.',
        context:
          'This text forms part of the \'Usage and privacy\' information panel in PHIEDU. You can access the full text via the "Usage and privacy" link in the left navigation bar.',
      },
      openIdH1: {
        message: 'Signing in to third-party applications using PHIEDU',
        context:
          'This text forms part of the \'Usage and privacy\' information panel in PHIEDU. You can access the full text via the "Usage and privacy" link in the left navigation bar.',
      },
      openIdP1: {
        message:
          'It is possible to use PHIEDU to register or sign in to third-party applications. If you do this, the other application will have access to your PHIEDU username, unique user ID, and full name.',
        context:
          'This text forms part of the \'Usage and privacy\' information panel in PHIEDU. You can access the full text via the "Usage and privacy" link in the left navigation bar.',
      },
    },

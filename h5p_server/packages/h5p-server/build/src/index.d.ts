...
export { AggregateH5pError, AjaxErrorResponse, AjaxSuccessResponse, cacheImplementations, ContentFileScanner, ContentId, ContentParameters, ContentPermission, ContentStorer, ContentTypeCache, ContentUserDataManager, FileSanitizerResult, fs, fsImplementations, GeneralPermission, H5PAjaxEndpoint, H5PConfig, H5PEditor, H5pError, H5PFile, H5PFileBuffer, H5PPlayer, IAdditionalLibraryMetadata, IAjaxResponse, IContentMetadata, IContentStorage, IContentUserData, IContentUserDataStorage, IEditorModel, IFileMalwareScanner, IFileSanitizer, IFileStats, IFinishedUserData, IGetContentUserData, IH5PConfig, IInstalledLibrary, IIntegration, IKeyValueStorage, ILibraryAdministrationOverviewItem, ILibraryFileUrlResolver, ILibraryInstallResult, ILibraryMetadata, ILibraryName, ILibraryStorage, ILicenseData, ILockProvider, InstalledLibrary, IPermissionSystem, IPlayerModel, IPostContentUserData, IPostUserFinishedData, ITemporaryFile, ITemporaryFileStorage, ITranslationFunction, IUrlGenerator, IUser, LaissezFairePermissionSystem, LibraryAdministration, LibraryManager, LibraryName, Logger, MalwareScanResult, PackageExporter, SimpleLockProvider, streamToString, TemporaryFileManager, TemporaryFilePermission, UrlGenerator, UserDataPermission, utils };
